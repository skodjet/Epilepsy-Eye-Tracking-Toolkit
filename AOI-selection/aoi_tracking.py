...
# TODO: This import was added by me.
...
# TODO: TEST
FRAME_WIDTH = int(__constants.total_surface_width)
FRAME_HEIGHT = int(__constants.total_surface_height)
...
# TODO: Remove this commented-out line if it's not needed
# output_file_name = 'output/' + unique_label + '.csv'

output_file_name = output_path + '\\' + unique_label + '.csv'
