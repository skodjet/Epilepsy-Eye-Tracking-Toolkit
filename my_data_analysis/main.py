...
# TODO: Testing replacing this with user inputted file names.
# original_aoi_filename = "C_obj_1.csv"
# gaze_filename = "C_gaze_positions.csv"
# aoi_filename = "C_obj_1.csv"
# participant_identifier = "C"

# # TODO: Take user input for files names
aoi_filename = input("Input AOI data file for this participant\n "
                     "(generated by the Dynamic AOI Toolkit): ")
gaze_filename = input("Input gaze data file for this participant (from PupilLabs): ")
participant_identifier = input("Input a participant identifier "
