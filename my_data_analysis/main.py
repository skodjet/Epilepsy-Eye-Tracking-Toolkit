...
# TODO: ***************** Commented out for testing purposes. Uncomment before committing *********************************
...
save_directory = os.path.dirname(os.path.realpath(__file__)) + '\\cleaned_files\\'
gaze_filename = save_directory + participant_identifier + "transformed_gaze.csv"
